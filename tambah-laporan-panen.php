...
<?php
 ...
 ?>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Tambah Laporan Panen</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index1.php">Home</a></li>
          <li class="breadcrumb-item active">Tambah Laporan Panen</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="col-md-8 offset-md-2">
            <div class="card">
              <div class="card-header">
                <h4>Tambah Data Laporan Panen</h4>
              </div>
              <div class="card-body">
                <form action="proses-tambah-admin.php" method="POST">
                  <div class="row mb-3">
                    <div class="col-md-6">
                      <label for="username" class="form-label">Panen ID</label>
