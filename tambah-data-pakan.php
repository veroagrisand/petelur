    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Pakan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="proses-tambah-admin.php" method="POST">
                  <div class="row mb-3">
                    <div class="col-md-6">
                      <label for="username" class="form-label">P_Pakan ID</label>
                  ...
                  <div class="row mb-2">
                    <div class="col-md-6">
                      <label for="username" class="form-label">Pakan</label>
                      <input type="text" class="form-control" id="username" name="username" required>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row mb-1">
                    <div class="col-md-6">
                      <label for="username" class="form-label">Tanggal Pemberian</label>
                      <input type="text" class="form-control" id="username" name="username" required>
                    </div>
                  </div>
                  <br>
