...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='tambah-anak-kandang.php'">+
        Tambah Data Anak Kandang</button>
      <br>
      <br>
